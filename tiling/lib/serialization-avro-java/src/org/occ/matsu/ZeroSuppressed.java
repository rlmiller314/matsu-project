...
public class ZeroSuppressed extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ZeroSuppressed\",\"namespace\":\"org.occ.matsu\",\"fields\":[{\"name\":\"index\",\"type\":\"long\"},{\"name\":\"strip\",\"type\":\"bytes\"}]}");
  ...
  public static org.occ.matsu.ZeroSuppressed.Builder newBuilder() {
    return new org.occ.matsu.ZeroSuppressed.Builder();
  }
  
  /** Creates a new ZeroSuppressed RecordBuilder by copying an existing Builder */
  public static org.occ.matsu.ZeroSuppressed.Builder newBuilder(org.occ.matsu.ZeroSuppressed.Builder other) {
    return new org.occ.matsu.ZeroSuppressed.Builder(other);
  }
  
  /** Creates a new ZeroSuppressed RecordBuilder by copying an existing ZeroSuppressed instance */
  public static org.occ.matsu.ZeroSuppressed.Builder newBuilder(org.occ.matsu.ZeroSuppressed other) {
    return new org.occ.matsu.ZeroSuppressed.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ZeroSuppressed>
    ...
    private Builder() {
      super(org.occ.matsu.ZeroSuppressed.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.occ.matsu.ZeroSuppressed.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing ZeroSuppressed instance */
    private Builder(org.occ.matsu.ZeroSuppressed other) {
            super(org.occ.matsu.ZeroSuppressed.SCHEMA$);
    ...
    /** Sets the value of the 'index' field */
    public org.occ.matsu.ZeroSuppressed.Builder setIndex(long value) {
    ...
    public org.occ.matsu.ZeroSuppressed.Builder clearIndex() {
    ...
    /** Sets the value of the 'strip' field */
    public org.occ.matsu.ZeroSuppressed.Builder setStrip(java.nio.ByteBuffer value) {
    ...
    public org.occ.matsu.ZeroSuppressed.Builder clearStrip() {
      strip = null;
