...
classpath = "/home/pivarski/odg/matsu-project/Libraries/Serialization with Avro/geoPictureSerializer.jar"
...
geoPictureSerializer.loadSerialized(open("/home/pivarski/NOBACKUP/GobiDesert01-small.serialized").read())
