...
public class AccumuloInterface {
    static String tableName = "quicktest10";
	...
	try {
		...
		System.out.println("Starting AccumuloInterface reader.");
		...
		System.out.println("Starting AccumuloInterface writer.");
	    ...
	    throw new RuntimeException("Pass a command ('read' or 'write').");
	}
    }
}
